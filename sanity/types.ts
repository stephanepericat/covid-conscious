...
// Query: {  "tags": array::unique(*[_type == $type] {    "tags": tags[]->uri.current  }  .tags[])  } | {    "t": *[_type == 'tag' && uri.current in ^.tags] | order(name[$locale], "desc") {      "id": uri.current,      "name": name[$locale]    }  }.t[]
